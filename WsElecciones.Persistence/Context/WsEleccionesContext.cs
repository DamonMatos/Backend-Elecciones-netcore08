...
public partial class WsEleccionesContext : DbContext
{
    public WsEleccionesContext()
    {
    }

    public WsEleccionesContext(DbContextOptions<CuentaCorrienteContext> options)
        : base(options)
    {
    }
